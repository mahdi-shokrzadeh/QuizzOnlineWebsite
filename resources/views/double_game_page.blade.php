...
<body>
                    ...
                    <div class="col-lg-5 side-bar">
                        <div class="first-part border">
                            <div class="container">
                                <div class="row top-bar">
                                    <div class="col-6 d-flex justify-content-center text-center">
                                        <div class="users-profile">
                                            ...
                                            <a href="{{route('profile' , ['url' => 'vCyfu8' ] )}}" class="badge badge-primary badge-pill">mahdi shokrzadeh</a>
                                            <div class="score">
                                    ...
                                    <div class="col-6 d-flex justify-content-center text-center">
                                        <div class="users-profile">
                                            ...
                                            <a href="{{route('profile' , ['url' => 'qQcF3P' ] )}}" class="badge badge-primary badge-pill">Ali</a>
                                ...
                                <div class="second-part mt-4 d-flex align-items-center justify-content-center border-top">
                                    <div class="control-buttons">
                                        <div class="mt-4">
                                            <a href="#" class="btn btn-outline-success">ادامه ی بازی<i class="fa fa-arrow-left ml-2"></i></a>
                                        </div>
                                        
                                        <div class="mt-3 mb-3 text-center">
                                            <button class="btn btn-outline-danger" onclick="ConfrimUser()">انصراف</button>
                                        </div>

                                        <div class="mt-3 mb-3 text-center">
                                            <a class="btn btn-outline-info" href="{{route('dashboard')}}">برگشت</a>
                                        </div>
                            ...
                            <div class="col-12">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="tab">
                                        <a href="#tab1" class="nav-link" role="tab" data-toggle="tab">مسابقه</a>
                                    </li>
        
                                    <!-- <li class="nav-item" role="tab">
                                        <a href="#tab2" class="nav-link" role="tab" data-toggle="tab">گفت و گو</a>
                                    </li> -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane  p-1" id="tab1">
                                        <div class="container mt-2">
                                            <div class="result align-items-center justify-content-center d-flex">
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <span class="badge badge-info mr-4 ml-4 p-1">اطلاعات عمومی</span>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                            </div>
                                            <div class="result align-items-center justify-content-center d-flex">
                                                ...
                                                <span class="badge badge-warning mr-5 ml-5 p-1">مذهبی</span>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                            </div>
                                            <div class="result align-items-center justify-content-center d-flex">
                                                ...
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <span class="badge badge-secondary mr-5 ml-5 p-1">ریاضی</span>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                            </div>
                                            <div class="result align-items-center justify-content-center d-flex">
                                                ...
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <span class="badge badge-primary p-1 mr-5 ml-5">تاریخ</span>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                            </div>
                                            <div class="result align-items-center justify-content-center d-flex">
                                                ...
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <span class="badge badge-dark mr-4 ml-4 p-1">علم و دانش</span>
                                                <i class="fa fa-circle fa-2x" style="color: red;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" ></i>
                                            </div>
                                            <div class="result align-items-center justify-content-center d-flex">
                                                ...
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: #49E20E;"></i>
                                                <span class="badge badge-warning p-1 mr-4 ml-4">زبان انگلیسی</span>
                                                <i class="fa fa-circle fa-2x" style="color: gray;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: gray;"></i>
                                                <i class="fa fa-circle fa-2x" style="color: gray;"></i>
                                            </div>
                                    ...
                                    <!-- <div role="tabpanel" class="tab-pane active p-1" id="tab2">
                                        <div class="chat ">
                                            <div class="container chat-box border"> 
                                                <span class="text-muted">در دست بروزرسانی</span>
                                            </div>
                                        </div>                        
    ...
    <script>
        ...
        function ConfrimUser() { 
            Swal.fire({
            title: 'مطمئنی میخوای انصراف بدی ؟ امتیازت کم میشه ها !',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            confirmButtonText: 'آره انصراف میدم' ,
